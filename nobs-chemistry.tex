...
\section{Electron configuration and orbital energy diagrams}
	...
	For ions, keep in mind that the number of electrons is NOT the same as the ion's atomic number. Be sure to incorporate that into your electron configurations. There is something special to keep in mind here: \textul{transition metal cations' nth s electrons will come off \textit{before} the (n-1)th d electrons}.
...
\section{Covalent bonding}
	...
	For example, \ce{Cr(CO)n}. $d = 2, v = 6$. $2n + 6 = 18$. $2n = 12$. $n = 6$.
